...
@section('title', 'Berita Desa - ' . strtoupper($villageProfile->village_name ?? 'Desa'))
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 mb-6">
        <div class="flex flex-col md:flex-row gap-4">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('news.index') }}" class="px-3 py-2 rounded-lg text-sm font-medium {{ !request('category') ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 dark:text-gray-300 hover:bg-gray-300' }}">
                    Semua
                </a>
