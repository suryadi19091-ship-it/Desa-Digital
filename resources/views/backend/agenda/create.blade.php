...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6"><h1>Tambah Agenda</h1></div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-calendar-plus mr-2"></i> Form Tambah Agenda</h3>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" rows="4" class="form-control @error('description') is-invalid @enderror"
                                  placeholder="Deskripsi agenda..." required>{{ old('description') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="location" class="form-control @error('location') is-invalid @enderror"
                                       value="{{ old('location') }}" placeholder="Tempat kegiatan" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="contact_person" class="form-control"
                                       value="{{ old('contact_person') }}" placeholder="Nama narahubung">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="contact_phone" class="form-control"
                                       value="{{ old('contact_phone') }}" placeholder="08xxxxxxxxxx">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="max_participants" class="form-control" min="1"
                                       value="{{ old('max_participants') }}" placeholder="Kosongkan = tidak terbatas">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                    ...
                                    <label class="custom-control-label" for="is_public">Agenda Publik (terlihat di website)</label>
                                </div>
                            </div>
                        </div>
                    </div>
